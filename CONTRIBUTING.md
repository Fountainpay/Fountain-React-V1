...
Please don't raise an issue to ask a question. You can ask questions on our [forum](http://forum.fountainpay.ng) or developer [slack](https://bit.ly/34Vkzcg). We have an army of Engineers on hand to answer your questions there.
...
If you need an additional feature added to the library, kindly send us an email at developers@fountainpay.ng. Be sure to include the following in your request:
